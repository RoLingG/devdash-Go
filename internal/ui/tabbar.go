...
func RenderStatusBar(active TabState, width int) string {
	...
	case TabLog:
		line1 := helpLine([]string{"\u2191\u2193 cursor", "[ ] page", "ctrl+p jump", "ctrl+l level", "/ open"}, width, sep)
		line2 := helpLine([]string{"type filter", "Esc clear", "ctrl+r refresh", "1/2/3/4 switch", "ctrl+q quit"}, width, sep)
		return line1 + "\n" + line2
